...
public class Respostas {
	...
	public String retornarMatricula(List<DadosDeCadaAluno> lista) {
		...
		for (DadosDeCadaAluno aluno : lista) {
			...
			frequenciaMatriculas.put(aluno.getMatricula(),
					frequenciaMatriculas.getOrDefault(aluno.getMatricula(), 0) + 1);

		}

		String matriculaMaisRepetida = Collections.max(frequenciaMatriculas.entrySet(), Map.Entry.comparingByValue())
				.getKey();
